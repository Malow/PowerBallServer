...
Server listens for connections, when found it sends them to the lobbyhandler.
...
Server is threaded, Lobbyhandler is threaded, every GameInstance is threaded and every Client is threaded.
*/
